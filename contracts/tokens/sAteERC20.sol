...
contract sAte is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Token Staked AteAO", "sAte", 9) ERC20Permit() {
    ...
    /**
        @notice increases sAte supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sAte
